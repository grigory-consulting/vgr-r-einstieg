...
# col_names = FALSE -> die erste Zeile wird nicht zu Spaltennamen kommentiert 
...
saveWorkbook(wb, "ergebnis_summe_2024_formatiert.xlsx", overwrite = TRUE)

install.packages("openxlsx2")
library(openxlsx2)

wb_workbook() |> #erstellen leerer Datei 
  wb_add_worksheet("Summe2024") |>
  wb_add_data(sheet = "Summe2024", x = res) |>
  wb_save("output/ergebnis_pipe.xlsx")
